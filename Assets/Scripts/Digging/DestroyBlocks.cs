...
public class DestroyBlocks : MonoBehaviour {
    ...
    [SerializeField] private float castDistance = 1.0f; //How far we will cast
    [SerializeField] private Transform raycastPoint; //The origin point of our cast
    [SerializeField] private LayerMask layer; //The layer we want to cast onto
    // [SerializeField] private List<Tilemap> _tilemaps = new List<Tilemap>();
    private float blockDestroyTime = 1.0f; //How long to delay between tile destructions
    Vector3 direction; 
    RaycastHit2D hit;
